...
func init() {
	...
	beego.GlobalControllerRouter["goyo.in/gpstracker/controllers:SyncGeoFenceController"] = append(beego.GlobalControllerRouter["goyo.in/gpstracker/controllers:SyncGeoFenceController"],
		beego.ControllerComments{
			Method: "Post",
